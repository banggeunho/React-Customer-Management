...
class CustomerAdd extends React.Component {
    ...
    addCustomer = () =>{
        ...
        // 파일이 포함되어 있는 데이터를 서버에 전송하고자 할때는 웹ㅍ표준에 맞는 헤더를 추가 해야함
        const config = {
            headers:{
            ...
            <div>
                ...
                <Dialog open={this.state.open} onClose ={this.handleClose}>
                    ...
                    <DialogContent>
                        ...
                        <TextField label = "생년월일" type="text" name = "birthday" value={this.state.birthday} onChange={this.handleValueChange}/><br/><br/>
